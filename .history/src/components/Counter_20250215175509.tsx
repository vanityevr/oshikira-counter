...
export const Counter = () => {
  ...
  return (
    <CardContent className="relative bg-rose-700 rounded-[20%] border-none px-8 py-4 flex flex-col gap-4 items-center overflow-hidden">
      ...
      <div className="flex flex-row gap-8">
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-xl text-white font-bold">Siodła zrobione dzisiaj:</h1>
          <p className="text-3xl text-white font-bold">{zrobione}</p>
        </div>
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-xl text-white font-bold">Siodła do wykonania:</h1>
          {loading ? (
            <p className="text-3xl text-white font-bold">?</p>
          ) : (
            <p className="text-3xl text-white font-bold">{siodla}</p>
          )}
        </div>
      </div>
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 items-center">
            ...
            <Input
              ...
              disabled={functionsDisabled}
            />
            <Button className="bg-black hover:bg-black" onClick={convertDonationToSiodla} disabled={functionsDisabled}>
              Dodaj siodła
            </Button>
          </CardContent>
        </Card>
      ...
      <DialogTrigger asChild>
        <Button disabled={!functionsDisabled} variant="outline" className="bg-black text-white text-md hover:bg-black hover:text-white">Odblokuj funkcje</Button>
      </DialogTrigger>
